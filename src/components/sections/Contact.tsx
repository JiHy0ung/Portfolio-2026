...
const RESUME_URL =
  "https://docs.google.com/document/d/1zwM9Mv63BSuHH6jbLxqI1J4SL2UYLfT5/edit?usp=sharing&ouid=104814082390429574261&rtpof=true&sd=true";
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="pt-28 pb-60">
